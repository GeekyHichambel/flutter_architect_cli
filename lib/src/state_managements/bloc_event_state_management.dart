...
/// BLoC (Event-Driven) state management implementation
class BlocEvtStateManagement extends BaseStateManagement {
  /// File writer utility
  final FileWriter fileWriter;

  /// Constructor
  BlocEvtStateManagement(this.fileWriter) : super(StateManagement.blocEvt);
